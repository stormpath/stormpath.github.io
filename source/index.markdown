            ...
            <div class="docs-node-container">
              <div class="docs-node-first-row">
                <div class="docs-node-img-container">
                  <svg class="svg node-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><style>
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          <a href="/java">
            <div class="docs-node-container">
              <div class="docs-node-first-row">
                <div class="docs-node-img-container">
                  <svg class="svg java-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs>
                  <style>
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          <a href="/angular">
            <div class="docs-node-container">
              <div class="docs-node-first-row">
                <div class="docs-node-img-container">
                  <svg class="svg node-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs>
                  <style>
                  .node-svg .cls-1{fill:none;stroke:#5fdfa3;stroke-miterlimit:10;stroke-width:2px;}
                  .node-svg .cls-2{fill:#5fdfa3;}
                  </style>
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          <a href="/ruby">
            <div class="docs-node-container">
              <div class="docs-node-first-row">
                <div class="docs-node-img-container">
                  <svg class="svg ruby-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs>
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          <a href="/dotnet">
            <div class="docs-node-container">
              <div class="docs-node-first-row">
                <div class="docs-node-img-container">
                  <svg class="svg net-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs>
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          <a href="/ios">
            <div class="docs-node-container">
              <div class="docs-node-first-row">
                <div class="docs-node-img-container">
                  <svg class="svg ios-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs>
