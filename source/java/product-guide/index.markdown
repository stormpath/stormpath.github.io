...
The authentication workflow relies on the `application` resource as a starting point. For more information on working with these workflows via the Java SDK after they have already been configured, refer to the [Working With Applications](#application-account-authc) section of this guide.
