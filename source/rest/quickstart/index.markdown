...
This quickstart will get you up and running with Stormpath in about 10 minutes and give you a good initial feel for the Stormpath REST API. During this quickstart, you will do the following:
...
## <a href='#apiKey'></a>Get an API Key
